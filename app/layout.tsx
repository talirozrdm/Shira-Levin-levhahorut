...
const description =
  "אני שירה לוין, מדריכת הורים בגישת אדלר, ומלווה אונליין הורים לילדים בגיל בית הספר, למתבגרים ולהורים לילדים על הרצף האוטיסטי, לחיזוק הקשר, הסמכות ההורית והתקשורת בבית.";
